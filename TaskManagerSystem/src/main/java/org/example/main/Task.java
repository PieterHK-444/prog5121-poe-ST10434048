...
//	int taskPriority; // task priority - another way to organize tasks
	...
	public Task(String taskName, String description, String date, User active_user, int status, int taskNumber, int duration) {
		_taskName = taskName;
